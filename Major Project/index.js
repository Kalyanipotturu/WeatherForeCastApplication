...
async function getWeather()
{
    ...
    let res = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=b00a0b99175cc88768fe4a89dc10e540&units=metric`);
    if(res==undefined){
...
getWeather();
    ...
    function appendsData(data)
    {
       ...
       {
        document.getElementById("cityName").innerText="Delhi";
        return false;
